  ...
  return <AuthGuard><div className="min-h-screen md:flex">
    <aside className="hidden w-[248px] shrink-0 border-r bg-card/70 p-4 md:flex md:flex-col">
      ...
      <div className="mt-auto border-t pt-4">
        ...
        <div className="mt-4 flex items-center gap-3 border-t px-2 pt-4"><Avatar><AvatarFallback>MC</AvatarFallback></Avatar><div className="min-w-0"><div className="truncate text-sm font-medium">Maya Chen</div><div className="mono truncate text-[11px] text-muted-foreground">@maya.creates</div></div><button aria-label="Sign out" onClick={signOut} className="ml-auto text-muted-foreground hover:text-foreground"><LogOut size={14} /></button></div>
      </div>
    </aside>
